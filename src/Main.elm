...
quizView model =
    let
        ( question, answer ) =
            getQuestionAnswer model
    in
    div [ Html.Attributes.class "preview flex w-full justify-center data-[align=center]:items-center data-[align=end]:items-end data-[align=start]:items-start h-[450px] p-10", attribute "data-align" "center" ]
